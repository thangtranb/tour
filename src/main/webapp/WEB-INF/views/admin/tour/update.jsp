...
<body>
	<div class="container">
		<h1 class="text-center">
			<spring:message code="addNewCourse" text="Update Tour" />
		</h1>
		...
		<input type="hidden" name="id" value="${tour.id}" />
			<div class="form-group">
				<label for=""><spring:message code="courseName"
					...
					class="form-control" placeholder="Tour Name.." value="${tour.tourName}">
			</div>

			<div class="form-group">
				<label for=""><spring:message code="image" text="Description" /></label>
				<input type="text" name="description" class="form-control" value="${tour.description}">

			</div>

			<div class="form-group">
				<label for=""><spring:message code="image" text="Schedule" /></label>
				<input type="text" name="schedule" class="form-control" value="${tour.schedule}">
			...
			<div class="form-group">
				<label for="name" class="col-md-3 text-md-right col-form-label"><spring:message
					...
					class="form-control" value="${tour.departureDay}">
			</div>
			
			<div class="form-group">
				<label for="name" class="col-md-3 text-md-right col-form-label"><spring:message
						code="price" text="Number Of Participants" /></label> <input name="numberoOfParticipants" type="number"
					class="form-control" value="${tour.numberoOfParticipants}">
			</div>

			<div class="form-group">
				<label for="name" class="col-md-3 text-md-right col-form-label"><spring:message
						code="endDate" text="Created at" /></label> <input name="created_at"
					type="date" class="form-control" value="${tour.created_at}">${tour.created_at}
			</div>

			<div class="form-group">
				<label for="name" class="col-md-3 text-md-right col-form-label"><spring:message
						code="numberOfStudent" text="Update at" /></label> <input
					name="update_at" type="date" class="form-control" value="${tour.update_at}">${tour.update_at}
			</div>

...
<head>
<meta charset="UTF-8">
<title>Booking Room Pages</title>
</head>
<body>
		...
		<div class="row">
			<div class="col-sm-12 col-xl-12">
				<div class="bg-light rounded h-100 p-4">
					...
					<h6 class="mb-4">
						<spring:message code="courseTable" text="Booking Room Table" />
					</h6>
					<a class="btn btn-primary" href="bookingRoom/insertBooking"
						role="button"><spring:message code="addNewCourse"
							text="Add New Booking Room" /></a>
					<div class="card-header mr-3">
						<form method="post"
							action="${pageContext.request.contextPath}/admin/bookingRoom/search">
